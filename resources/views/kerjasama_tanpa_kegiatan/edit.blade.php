...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            {{-- Form edit data --}}
            <form action="{{ route('kerjasama_tanpa_kegiatans.update', ['kerjasama_tanpa_kegiatan' => $kerjasama->id]) }}"
                method="POST">
                @method('PUT')
                @csrf
                ...
                &nbsp;
                <a href="/kerjasama_tanpa_kegiatans" class="btn btn-outline-dark">Kembali</a>
            </form>
        </div>
    </div>
